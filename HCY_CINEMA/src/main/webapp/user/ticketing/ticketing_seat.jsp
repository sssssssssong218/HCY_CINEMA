...
<div id="cgvwrap">
	...
	<!-- Contaniner -->
	<iframe title="CGV 빠른예매" id="ticket_iframe" src="http://localhost/HCY_CINEMA/user/ticketing/ticketing_seat_frame.jsp" scrolling="no" frameborder="0" width="100%" height="750px" style="width:100%; border:0 none;"></iframe>
    <!-- E Contaniner -->
