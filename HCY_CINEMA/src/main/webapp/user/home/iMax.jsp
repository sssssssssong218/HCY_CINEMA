...
<!-- S Contaniner -->
    <div id="contaniner">
        ...
        <!-- 상단 띠베너-->
        <article class="special_detail_top">  <div class="contents">      <div class="img_wrap" data-scale="false">          <img src="http://img.cgv.co.kr/WebApp/contents/specialTheater/list1/16844565213590.png" alt="궁극의 몰입감" onerror="errorImage(this)">      </div>      <strong class="special_detail_title">IMAX</strong>      <span class="special_detail_subTitle">궁극의 몰입감<span>  </span></span></div></article>
        <!-- BI 리스트-->
        <!-- 유닛관리-->
        <article class="specialtheater_detail_edit_wrap"><div class="specialtheater_detail_edit_contents_wrap">
<div class="contents">
<ul class="imax_list">
	<li>
	<div class="img_wrap" data-scale="false"><img alt="Crystal Clear IMAGE" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/imax/imax_list0.png"></div>
	<strong><span>Crystal Clear</span>IMAGE</strong> <span>Customized Projector로<br>
	비교할 수 없는 밝음과 뛰어난<br>
	선명한 화질 제공</span></li>
	<li>
	<div class="img_wrap" data-scale="false"><img alt="Maximized SCREEN" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/imax/imax_list1.png"></div>
	<strong><span>Maximized</span>SCREEN</strong> <span>대형 스크린에 맞는<br>
	맞춤형 설계로 모든 좌석에서<br>
	최고의 몰입&nbsp;가능</span></li>
	<li>
	<div class="img_wrap" data-scale="false"><img alt="Powerful SOUND" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/imax/imax_list2.png"></div>
	<strong><span>Powerful</span>SOUND</strong> <span>완벽하게 조율된 소리와<br>
	핀 포인트 정확도로<br>
	최적의 사운드를 제공</span></li>
</ul>
</div>
