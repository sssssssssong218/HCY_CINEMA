...
<div id="contaniner">
        ...
        <!-- 상단 띠베너-->
        <article class="special_detail_top">  <div class="contents">      <div class="img_wrap" data-scale="false">          <img src="http://img.cgv.co.kr/WebApp/contents/specialTheater/list1/16844576880990.png" alt="대관형 프리미엄 상영관" onerror="errorImage(this)">      </div>      <strong class="special_detail_title">THE PRIVATE CINEMA</strong>      <span class="special_detail_subTitle">대관형 프리미엄 상영관<span>  </span></span></div></article>
        <!-- BI 리스트-->
        <!-- 유닛관리-->
        <article class="specialtheater_detail_edit_wrap"><div class="contents"><strong class="specialtheater_detail_edit_title tAlignC">Special Memories</strong> <span class="specialtheater_detail_edit_context tAlignC"> 높다란 천정을 수놓은 조명과 부드럽고 따뜻한 느낌을 더하는 우드 플로링, 디자인 체어 맞은편으로 늘어선 서가의 풍경이 한 편의 클래식 무비에 등장하는 소셜클럽을 떠올리게 합니다.<br>
영화를 관람하는 경험 그 자체가 특별한 추억이 되는 곳!<br>
품격있는 문화와 편안함을 누릴 수 있는 최고의 공간으로 여러분을 초대합니다. </span> <img alt="THE PRIVATE CINEMA 이미지1" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/theprivatecinema/theprivatecinema_01.jpg"> <strong class="specialtheater_detail_edit_title">Private Lounge</strong> <span class="specialtheater_detail_edit_context">고객의 취향과 모임의 규모, 성격에 따라 원하는 대로 연출할 수 있습니다.</span> <img alt="THE PRIVATE CINEMA 이미지2" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/theprivatecinema/theprivatecinema_02.jpg"> <strong class="specialtheater_detail_edit_title">B&amp;W System</strong> <span class="specialtheater_detail_edit_context">베이스 스피커만 6개, 8.1채널로 구성된 최상위 극장용 음향 시스템을 사용합니다.</span> <img alt="THE PRIVATE CINEMA 이미지3" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/theprivatecinema/theprivatecinema_03.jpg"> <strong class="specialtheater_detail_edit_title">Catering Service</strong> <span class="specialtheater_detail_edit_context">이용 형태에 따라 푸드 컨설턴트가 맞춤 케이터링 서비스를 제안해 드립니다.</span> <img alt="THE PRIVATE CINEMA 이미지4" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/theprivatecinema/theprivatecinema_04.jpg"></div></article>
        
        
        
        <article class="specialtheater_detail_link_info_wrap">    <div class="contents">        <div class="specialtheater_detail_link_info_txt_wrap">            <strong>고객</strong>님, 이런 정보 찾고 계신가요?         </div>        <ul class="specialtheater_detail_link_info_list">            <li><a href="http://www.cgv.co.kr/theaters/special/default.aspx?regioncode=pc&amp;submenu=rent">대관 안내</a></li>        <!-- ul -->    <!-- div --></ul></div></article>
