...
<div id="contaniner">
        ...
        <!-- 상단 띠베너-->
        <article class="special_detail_top">  <div class="contents">      <div class="img_wrap" data-scale="false">          <img src="http://img.cgv.co.kr/WebApp/contents/specialTheater/list1/16844566032440.png" alt="3면 확장 스크린" onerror="errorImage(this)">      </div>      <strong class="special_detail_title">SCREENX</strong>      <span class="special_detail_subTitle">3면 확장 스크린<span>  </span></span></div></article>
        <!-- BI 리스트-->
        <!-- 유닛관리-->
        <article class="specialtheater_detail_edit_wrap"><div class="contents screenx"><strong class="specialtheater_detail_edit_title tAlignC">Expanding The Cinema Space</strong> <span class="specialtheater_detail_edit_context tAlignC"> ScreenX는 스크린의 경계를 넘어 극대화된 현장감을 제공하는<br>
전세계 가장 트렌디한 무비포맷입니다. </span> <img alt="SCREENX 사진1" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/screenx/specialtheater_screenx0.jpg"> <span class="specialtheater_detail_edit_context tAlignC"> 지금까지 우리는 좁은 화면에 갇혀 있었습니다.<br>
ScreenX가 마치 현장에 있는 것처럼 실감나는 이유는<br>
270도까지 스크린을 3면으로 확장하여 화면이 공간으로 느껴지기 때문!<br>
100여개의 ScreenX 특허 기술로 기존 영화관에서 볼 수 없던 공간감을 경험하세요</span>
<dl class="screenx_link_list">
	<dt>SCREENX에 대해 더 알아보세요!</dt>
	<dd><a href="http://www.screenxmovies.com" target="_blank"><i class="cgvIcon home_fill">home_fill</i>HOMEPAGE</a></dd>
	<dd><a href="https://www.facebook.com/443973975675180" target="_blank"><i class="cgvIcon facebook">facebook</i>FACEBOOK</a></dd>
	<dd><a href="https://www.youtube.com/user/TheScreenX" target="_blank"><i class="cgvIcon youtube">youtube</i>YOUTUBE</a></dd>
</dl>

<div class="specialtheater_video_wrap">
