...
<div id="contaniner">
        ...
        <!-- 상단 띠베너-->
        <article class="special_detail_top">  <div class="contents">      <div class="img_wrap" data-scale="false">          <img src="http://img.cgv.co.kr/WebApp/contents/specialTheater/list1/16844577273360.png" alt="자연 컨셉의 힐링 상영관" onerror="errorImage(this)">      </div>      <strong class="special_detail_title">CINE &amp; FORET</strong>      <span class="special_detail_subTitle">자연 컨셉의 힐링 상영관<span>  </span></span></div></article>
        <!-- BI 리스트-->
        <!-- 유닛관리-->
        <article class="specialtheater_detail_edit_wrap"><div class="contents"><strong class="specialtheater_detail_edit_title tAlignC">Greenery &amp; Healing</strong> <span class="specialtheater_detail_edit_context tAlignC"> 순록 이끼 벽면과 슬로프형 실내 잔디로 꾸민 씨네앤포레는<br>
도심 속 푸르름의 가치를 전달하는 힐링 상영관입니다.<br>
안락한 좌석과 개인 테이블로 편안함을, 자연의 향기로 싱그러움을 더해<br>
누구나 꿈꾸는 숲 속 영화관을 선사합니다. </span> <strong class="specialtheater_detail_edit_title_kr borderT">숲을 닮은</strong> <span class="specialtheater_detail_edit_context">순록이끼 벽면의 슬로프형 실내 잔디로 꾸며진 푸르른 공간은 자연의 향기로 싱그러움을 더했습니다.</span> <img alt="숲을 닮은" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/cinenforet/specialtheater_cinenforet_0.jpg"> <strong class="specialtheater_detail_edit_title_kr">숲과 같이 포근한</strong> <span class="specialtheater_detail_edit_context">매트, 빈백, 카바나 3종류의 안락한 좌석과 개인 테이블은 누구나 한번쯤 꿈꾸었던 숲 속 영화관을 선사합니다.</span> <img alt="숲과 같이 포근한" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/cinenforet/specialtheater_cinenforet_1.jpg"> <strong class="specialtheater_detail_edit_title_kr">숲처럼 즐거운</strong> <span class="specialtheater_detail_edit_context">미세먼지 걱정 없이 영화 관람 전 미디어아트와 힐링영상을 즐기며 다양한 F&amp;B메뉴로 피크닉 기분을 느껴보세요.</span> <img alt="숲처럼 즐거운" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/cinenforet/specialtheater_cinenforet_2.jpg"></div></article>
        
        
        <article class="specialtheater_detail_link_info_wrap">    <div class="contents">        <div class="specialtheater_detail_link_info_txt_wrap">            <strong>고객</strong>님, 이런 정보 찾고 계신가요?         </div>        <ul class="specialtheater_detail_link_info_list">            <li><a href="http://www.cgv.co.kr/theaters/theaterPrice.aspx?tc=0001&amp;spe=CF">가격안내</a></li>        <!-- ul -->    <!-- div --></ul></div></article>
