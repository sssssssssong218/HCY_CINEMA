...
<title id="ctl00_headerTitle"> 이메일주소 무단 수집 거부 &lt; HCY_CINEMA 홈페이지</title>    
...
<div class="sect-rules email">
    <h3>이메일주소 무단 수집 거부</h3>
    <div class="box-rules">
       <strong>HCY CINEMA는 회원님의 이메일주소를 매우 중요시 생각하며, 무단수집에 거부합니다.</strong>
       <p>본 웹사이트에 게시된 이메일주소가 전자우편수집 프로그램이나 그 밖의 기술적 장치를 이용하여 무단으로 수집되는 것을 거부하며,<br>이를 위반 시 정보통신망법에 의해 형사처벌 됨을 유념하시기 바랍니다.</p>
    </div>
</div>
