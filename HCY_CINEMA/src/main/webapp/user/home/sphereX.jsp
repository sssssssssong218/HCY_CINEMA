...
<div id="contaniner">
        ...
        <!-- 상단 띠베너-->
        <article class="special_detail_top">  <div class="contents">      <div class="img_wrap" data-scale="false">          <img src="http://img.cgv.co.kr/WebApp/contents/specialTheater/list1/16844566818680.png" alt="진화된 스크린" onerror="errorImage(this)">      </div>      <strong class="special_detail_title">SPHEREX</strong>      <span class="special_detail_subTitle">진화된 스크린<span>  </span></span></div></article>
        <!-- BI 리스트-->
        <!-- 유닛관리--><br><br><br>
        <article class="specialtheater_list_wrap">    <div class="contents">        <div class="swiper specialtheater_list swiper-container-initialized swiper-container-horizontal" style="cursor: grab;">            <div class="swiper-wrapper disabled" style="transform: translate3d(0px, 0px, 0px);">                <div class="swiper-slide swiper-slide-active" style="width: 980px;">                    <div class="video_wrap">                        <img src="http://img.cgv.co.kr/WebApp/contents/specialTheater/banner/16551979694890.png" onerror="errorImage(this)">                        <strong class="title" data-swiper-parallax="-1000" style="color:#FFFFFF">진화된 스크린<br>SPHEREX</strong>                    </div>                </div>            </div>            <a href="#none" class="specialtheater_list-next" style="display: none;"></a>            <a href="#none" class="specialtheater_list-prev" style="display: none;"></a>            <div class="swiper-pagination"></div>        <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>    </div></article>
        <article class="specialtheater_detail_edit_wrap"><div class="contents"><strong class="specialtheater_detail_edit_title tAlignC">More Than Real</strong> <span class="specialtheater_detail_edit_context tAlignC"> SPHEREX는 3S(Screen, Sound, Seat)가 진화·결합하여</span>
<p>&nbsp;</p>
<span class="specialtheater_detail_edit_context tAlignC">극대화된 공간적 몰입감을 제공하는 반구 형태의 특별관입니다.</span></div>
<span class="specialtheater_detail_edit_context tAlignC">콘텐츠 관람에 최적화된 환경을 제공하여 '나를 감싸는 극강의 몰입감'을 즐길 수 있습니다.</span>

<p class="fourdx_list_comment">* 극장별 스크린, 좌석 사양이 상이할 수 있습니다.</p></article>
        
        
        <article class="specialtheater_detail_link_info_wrap">    <div class="contents">        <div class="specialtheater_detail_link_info_txt_wrap">            <strong>고객</strong>님, 이런 정보 찾고 계신가요?         </div>        <ul class="specialtheater_detail_link_info_list">            <li><a href="http://www.cgv.co.kr/theaters/theaterPrice.aspx?tc=0088&amp;spe=SPX">가격안내</a></li>        <!-- ul -->    <!-- div --></ul></div></article>
