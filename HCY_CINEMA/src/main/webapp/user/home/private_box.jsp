...
<div id="contaniner">
        ...
        <!-- 상단 띠베너-->
        <article class="special_detail_top">  <div class="contents">      <div class="img_wrap" data-scale="false">          <img src="http://img.cgv.co.kr/WebApp/contents/specialTheater/list1/16844574293100.png" alt="박스형 프리미엄 상영관" onerror="errorImage(this)">      </div>      <strong class="special_detail_title">PRIVATE BOX</strong>      <span class="special_detail_subTitle">박스형 프리미엄 상영관<span>  </span></span></div></article>
        <!-- BI 리스트-->
        <!-- 유닛관리-->
        <article class="specialtheater_detail_edit_wrap"><div class="contents"><strong class="specialtheater_detail_edit_title tAlignC">The Cinema, Just For Us</strong> <span class="specialtheater_detail_edit_context tAlignC">우리만의 공간에서 가장 특별하게 보내는 시간</span></div>

<div class="specialtheater_detail_edit_contents_wrap">
<div class="contents">
<ul class="privatebox_list">
	<li>
	<div class="img_wrap" data-scale="false"><img alt="PRIVATE" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/privatebox/privatebox_list0.png"></div>
	<strong>PRIVATE</strong> <span>박스 타입의 독립된 공간에서<br>
	최대 2~4인까지 즐길 수 있는<br>
	쾌적한 영화 관람 환경을<br>
	선사합니다.</span></li>
	<li>
	<div class="img_wrap" data-scale="false"><img alt="PREMIUM" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/privatebox/privatebox_list1.png"></div>
	<strong>PREMIUM</strong> <span>전 좌석 최고급 리클라이닝<br>
	체어에 세련된 인테리어를<br>
	더해 차별화된 극장의<br>
	감성을 제공합니다.</span></li>
	<li>
	<div class="img_wrap" data-scale="false"><img alt="EXCLUSIVE SERVICE" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/privatebox/privatebox_list2.png"></div>
	<strong>EXCLUSIVE<br>
	SERVICE</strong> <span>웰컴 서비스로 다양한 드링크 및<br>
	핑거 푸드를 제공합니다.</span></li>
</ul>
</div>
</div>

<div class="contents privatebox"><span class="specialtheater_detail_edit_context tAlignC">여러 특별관과 융합되어 영화관의 가치는 그대로,<br>
프라이빗 상영관 서비스를 즐길 수 있습니다. </span>

<ul class="privatebox_chain_list">
	<li><span style="font-size:0.750em;">용산아이파크몰</span></li>
	<li>영등포</li>
	<li>연남</li>
	<li><span style="font-size:0.750em;">서면상상마당</span></li>
	<li>인천</li>
	<li>압구정</li>
	<li>천안터미널</li>
	<li>동탄</li>
...
<ul class="privatebox_chain_content_list">
	<li><img alt="용산아이파크몰 - 일반관 융합 상영관" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/privatebox/specialtheater_privatebox0.jpg"> <strong>용산아이파크몰</strong> <span>일반관 융합 상영관</span>

	<ul class="privatebox_chain_inner_list">
		<li>누하스(NOUHAUS) 리클라이닝 소파와 안마의자 구비</li>
		<li>PRIVATE BOX 전용 엘리베이터 운영</li>
		<li>홈 라이브러리, 리빙룸 두 가지 컨셉</li>
	</ul>
	</li>
	<li><img alt="영등포 - SCREENX 융합 상영관" height="320" src="http://img.cgv.co.kr/Event/cultureplexPhoto/16698783866740.jpg" width="970"> <strong>영등포</strong> <span>SCREENX 융합 상영관</span>
	<ul class="privatebox_chain_inner_list">
		<li>글로벌 최장 너비 극장 스크린 보유 (5면 스크린)</li>
		<li>PRIVATE BOX 전용 입장로 운영 (7~8F)</li>
		<li>컨시어지 서비스 제공</li>
		<li>공연 특화 오페라하우스 컨셉</li>
	</ul>
	</li>
	<li><img alt="연남 - SUITE CINEMA 융합 상영관" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/privatebox/specialtheater_privatebox2.jpg"> <strong>연남</strong> <span>SUITE CINEMA 융합 상영관</span>
	<ul class="privatebox_chain_inner_list">
		<li>스위트 패키지 제공 (무릎담요, 실내용 슬리퍼 등)</li>
		<li>거실타입의 부스형 좌석과 결합된 호텔 스위트룸 컨셉</li>
	</ul>
	</li>
	<li><img alt="서면상상마당 - 전석 PRIVATE BOX 상영관" height="320" src="http://img.cgv.co.kr/Event/cultureplexPhoto/16764217710440.jpg" width="500"> <strong>서면상상마당</strong> <span>전석 PRIVATE BOX 상영관</span>
	<ul class="privatebox_chain_inner_list">
		<li>PRIVATE BOX 전용 상영관</li>
		<li>온전히 독립된 공간 컨셉</li>
	</ul>
	</li>
	<li><img alt="서면상상마당 - 전석 PRIVATE BOX 상영관" height="320" src="http://img.cgv.co.kr/Event/cultureplexPhoto/16621103781540.JPG" width="970"> <strong>인천</strong> <span>일반관 융합 상영관</span>
	<ul class="privatebox_chain_inner_list">
		<li>커플 관람에 최적화된 넓은 상영관</li>
	</ul>
	</li>
	<li><img alt="서면상상마당 - 전석 PRIVATE BOX 상영관" height="320" src="http://img.cgv.co.kr/Event/cultureplexPhoto/16698784084520.jpg" width="970"> <strong>압구정</strong> <span>IMAX 융합 상영관</span>
	<ul class="privatebox_chain_inner_list">
	...
	<li><img alt="서면상상마당 - 전석 PRIVATE BOX 상영관" height="320" src="http://img.cgv.co.kr/Event/cultureplexPhoto/16704785092030.png" width="970"> <strong>천안터미널</strong> <span>일반관 융합 상영관</span>
	<ul class="privatebox_chain_inner_list">
		<li>커플 관람에 최적화된 상영관</li>
	</ul>
	</li>
	<li><img alt="서면상상마당 - 전석 PRIVATE BOX 상영관" height="320" src="http://img.cgv.co.kr/Event/cultureplexPhoto/16764218015730.jpg" width="500"> <strong>동탄</strong> <span>일반관/SCREENX 융합 상영관</span>
	<ul class="privatebox_chain_inner_list">
		<li>일반관(3관), SCREENX(6관) 융합 상영관</li>
	</ul>
	</li>
</ul>
</div></article>
        ...
        <article class="specialtheater_detail_link_info_wrap">    <div class="contents">        <div class="specialtheater_detail_link_info_txt_wrap">            <strong>고객</strong>님, 이런 정보 찾고 계신가요?         </div>        <ul class="specialtheater_detail_link_info_list">            <li><a href="">가격안내</a></li>        <!-- ul -->    <!-- div --></ul></div></article>
