...
<div id="contaniner">
        ...
        <!-- 상단 띠베너-->
        <article class="special_detail_top">  <div class="contents">      <div class="img_wrap" data-scale="false">          <img src="http://img.cgv.co.kr/WebApp/contents/specialTheater/list1/16844575399490.png" alt="프리미엄 소파 상영관" onerror="errorImage(this)">      </div>      <strong class="special_detail_title">GOLD CLASS</strong>      <span class="special_detail_subTitle">프리미엄 소파 상영관<span>  </span></span></div></article>
        <!-- BI 리스트-->
        <!-- 유닛관리-->
        <article class="specialtheater_detail_edit_wrap"><div class="contents goldclass"><strong class="specialtheater_detail_edit_title tAlignC">Premium &amp; Cozy</strong> <span class="specialtheater_detail_edit_context tAlignC"> 최고의 몰입감을 주는 Curved 스크린과 디테일한 사운드를 느끼실 수 있는 라인어레이 스피커,<br>
최상의 안락함을 주는 리클라이너 좌석까지 최고의 관람환경을 제공함과 동시에<br>
웰컴음료/컴포트패키지, 핸드폰 충전 서비스, 개인물품 수납 테이블 등<br>
고객 맞춤형 서비스까지 제공되는 프리미엄 상영관입니다. </span> <img alt="GOLD CLASS 이미지1" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/goldclass/goldclass_01.jpg"> <img alt="GOLD CLASS 이미지2" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/goldclass/goldclass_02.jpg"> <strong class="specialtheater_detail_edit_title">Recliner Chair</strong> <span class="specialtheater_detail_edit_context">최상의 안락함을 주는 리클라이너 좌석</span>
<div class="specialtheater_detail_theaterInfo_wrap">
<div class="specialtheater_detail_theaterInfo_img_wrap"><img alt="Recliner Chair 사진1" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/goldclass/goldclass_10.jpg"> <img alt="Recliner Chair 사진2" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/goldclass/goldclass_11.jpg"></div>
</div>
<strong class="specialtheater_detail_edit_title">Special Service</strong> <span class="specialtheater_detail_edit_context">웰컴 드링크와 컴포트 패키지 제공 </span>

<p class="goldclass_comment">*제공되는 서비스는 지점별로 상이할 수 있습니다.</p>

<div class="specialtheater_detail_theaterInfo_wrap">
<div class="specialtheater_detail_theaterInfo_img_wrap"><img alt="Special Service 사진1" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/goldclass/goldclass_20.jpg"> <img alt="Special Service 사진2" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/goldclass/goldclass_21.jpg"></div>
</div>
</div></article>
        <article class="specialtheater_detail_link_info_wrap">    <div class="contents">        <div class="specialtheater_detail_link_info_txt_wrap">            <strong>고객</strong>님, 이런 정보 찾고 계신가요?         </div>        <ul class="specialtheater_detail_link_info_list">            <li><a href="http://www.cgv.co.kr/theaters/theaterPrice.aspx?tc=0013&amp;spe=99">가격 안내</a></li>            <li><a href="http://www.cgv.co.kr/theaters/special/default.aspx?regioncode=99&amp;submenu=rent">대관 안내</a></li>            <li><a href="http://www.cgv.co.kr/culture-event/popcorn-store/product-detail.aspx?GG_NO=100026">관람권 구매</a></li>        <!-- ul -->    <!-- div --></ul></div></article>
