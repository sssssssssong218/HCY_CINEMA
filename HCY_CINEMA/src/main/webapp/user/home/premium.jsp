...
<div id="contaniner">
        ...
        <!-- 상단 띠베너-->
        <article class="special_detail_top">  <div class="contents">      <div class="img_wrap" data-scale="false">          <img src="http://img.cgv.co.kr/WebApp/contents/specialTheater/list1/16844577116350.png" alt="리클라이너 상영관" onerror="errorImage(this)">      </div>      <strong class="special_detail_title">PREMIUM</strong>      <span class="special_detail_subTitle">리클라이너 상영관<span>  </span></span></div></article>
        <!-- BI 리스트-->
        <!-- 유닛관리-->
