...
<div id="contaniner">
        ...
        <!-- 상단 띠베너-->
        <article class="special_detail_top">  <div class="contents">      <div class="img_wrap" data-scale="false">          <img src="http://img.cgv.co.kr/WebApp/contents/specialTheater/list1/16632369964330.jpg" alt="차세대 몰입형 사운드" onerror="errorImage(this)">      </div>      <strong class="special_detail_title">DOLBY ATMOS</strong>      <span class="special_detail_subTitle">차세대 몰입형 사운드<span>  </span></span></div></article>
        <!-- BI 리스트-->
        <!-- 유닛관리-->
        <article class="specialtheater_detail_edit_wrap"><div class="contents fourdxscreen"><strong class="specialtheater_detail_edit_title tAlignC">Dolby Atmos at the movies</strong> <span class="specialtheater_detail_edit_context tAlignC">CGV DOLBY ATMOS 상영관에서 변화하는 스토리의 힘을 느껴보세요</span><br>
<img alt="4DXSCREEN 사진1" height="530" src="http://img.cgv.co.kr/Event/cultureplexPhoto/16633090584910.png" width="980">&nbsp;<br>
&nbsp;
<div class="contents fourdxscreen"><strong class="specialtheater_detail_edit_title tAlignC">Hear what you've been missing</strong> <span class="specialtheater_detail_edit_context tAlignC">서라운드 사운드에서 한 단계 도약하는 돌비 애트모스는<br>
생생하고 강렬하며 몰입감 넘치는 사운드를 경험할 수 있게 해주어 스토리 깊숙히 들어가게 합니다.</span> <img alt="4DXSCREEN 사진1" height="530" src="http://img.cgv.co.kr/Event/cultureplexPhoto/16633093879580.jpg" width="980"></div>
</div></article>
