...
<div class="wrap-login">
    ...
    <p>에이치씨와이씨네마(주) 는 회원님의 개인정보를 매우 중요시하며, <strong>정보통신망 이용촉진 및 정보보호 등에 관한 법률,</strong><br>개인정보 보호법 등 관련 법률을 준수하고 있습니다.<br>에이치씨와이씨네마(주) 는 개인정보 처리방침을 통하여 회원님께서 제공한 개인정보가 어떠한 용도와 방식으로 이용되고 있으며,<br> 개인정보보호를 위해어떠한 조치가 취해지고 있는지 알려드립니다.</p>
...
<p>에이치씨와이씨네마㈜는 보다 다양하고 특성화된 고객 서비스 제공을 위하여 다음과 같이 고객 개인의 정보를 처리하고 있습니다.</p>
		...
		<table border="1" cellpadding="1" cellspacing="1">
			...
			<tbody>
				<tr>
					...
					<td>선호 극장(자주 가는 HCY), 주소, 결혼 여부, 선호 장르, 주중 선호 요일, 선호 시간대, 동반 관람인, 총 관람 인원수, 생년월일, 성별, 문자/이메일/앱푸시(알람) 광고 수신 동의 여부</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>휴대폰 번호, 선호 극장(자주 가는 HCY), 결혼 여부, 기념일, 선호 장르, 주중 선호 요일, 선호 시간대, 동반 관람인, 총 관람 인원수, 생년월일, 성별, 문자/이메일/앱푸시(알람) 광고 수신동의 여부</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>선호 극장(자주 가는 HCY), 주소, 휴대폰 번호, 이메일 주소, 문자/이메일/앱푸시(알람) 광고 수신동의 여부</td>
				</tr>
				<tr>
					<td>ㆍ설문 조사 시 통계분석</td>
...
<ol class="terms_list_circleNum">
	<li>
	<h2>에이치씨와이씨네마㈜는 서비스 계약의 성립 및 이행에 필요한 최소한의 개인정보를 수집합니다.</h2>
	</li>
	<li>
	<h2>에이치씨와이씨네마㈜는 이용자의 개인 식별이 가능한 개인정보를 수집하는 때에는 반드시 아래의 적법한 절차에 따라 당해 이용자의 동의를 받습니다.</h2>

	<ol>
		<li>
		<h3>개인정보 수집 방법</h3>
		<span>에이치씨와이씨네마㈜는 HCY 홈페이지와 HCY CINEMA 홈페이지 및 모바일, 현장, 로그분석, 쿠키를 통해 회원정보를 수집하고 있습니다.</span></li>
		<li>
		<h3>개인정보 수집에 대한 동의 절차</h3>
		<span>회원의 개인정보 수집과 관련하여 에이치씨와이씨네마㈜ 및 HCY의 개인정보처리방침 또는 이용약관을 통해 그 내용을 고지하고 있으며, 회원에게 수집하는 개인정보의 항목과 이용목적 및 보유기간, 거부권에 대해 고지 후 회원이 내용에 대해 「동의」 버튼을 클릭하면 개인정보 수집에 대해 동의한 것으로 봅니다. HCY CINEMA는 서비스 제공에 반드시 필요한 필수 항목과 부가적인 서비스 제공을 위한 선택 항목을 구분하여 고객 동의를 받고 있으며, 선택 항목은 서비스 내용 및 목적에 따라 별도 동의를 받고 있습니다.</span></li>
	</ol>
	</li>
</ol>
...
<ol class="terms_list_circleNum">
	<li>
	<h2>에이치씨와이씨네마㈜는 회원의 동의가 있거나 관련 법률의 규정에 의한 경우를 제외하고는 어떠한 경우에도 본 개인정보처리방침에서 고지한 범위를 넘어 회원의 개인정보를 이용하거나 제공하지 않습니다.</h2>
	</li>
	<li>
	...
	<li>
	<h2>HCY는 아래와 같이 개인정보를 제공하고 있습니다.</h2>
	...
	<table border="1" cellpadding="1" cellspacing="1">
		...
		<tbody>
			<tr>
				<td>HCY네트웍스㈜ (HCY 서비스)</td>
				<td>웹사이트 로그인, HCY 포인트 적립 및 사용, 기타 HCY 멤버십 관련 서비스 제공</td>
				<td>CI(연계정보), 회원번호(HCY), 성명, 생년월일, 성별, 아이디, 비밀번호, 휴대폰번호, 이메일 주소, 회원 등급</td>
				<td>HCY CINEMA 이용약관 철회 또는 HCY 탈퇴 시까지</td>
			</tr>
			<tr>
				<td>훅클라이밍<br>
				더훅클라이밍</td>
			...
			<tr>
				...
				HCY프레시웨이㈜<br>
				에이치빙㈜</td>
				<td>1) 각 HCY계열사의 고유 상품/서비스 제공, 유지, 개선, 고도화, 최적화 및 신규 상품/서비스 개발<br>
				2) 각 HCY계열사 보유 온-오프라인 채널 간 연계 및 통합을 통한 다양한 서비스 개발, 제공, 유지, 개선, 고도화 및 최적화<br>
				...
				7) 위 각 호의 목적을 위한 HCY계열사의 보유 데이터의 수집, 저장, 연계, 연동, 결합, 조합, 분해, 분석, 가공, 편집, 추출, 가명화, 비식별화, 기타 다양한 방법의 처리 및 이를 통한 새로운 데이터 생성, 인공지능 및 빅데이터 기술 개발</td>
				<td>인적정보[성명, 생년월일, 성별, CI(연계정보) 주소, 이동전화번호, 이메일, 아이디], 기록정보[접속로그(IP 포함), 쿠키, 서비스이용기록(로그인, 동의 여부, 조회 이력 등)], 서비스 이용 내용[구매내역(상품명, 금액 등), 결제정보(수단, 내역, 사용처 등), 상담정보, 프로모션/이벤트 이용 정보, 이용자 입력 정보] 및 위 정보와 HCY계열사 항목 정보를 결합, 분석, 추출하여 생성된 정보</td>
...
<ol class="terms_list_circleNum">
	<li>
	<h2>에이치씨와이씨네마㈜는 개인정보의 처리와 관련하여 아래와 같이 개인정보 처리업무를 위탁하고 있습니다. 관계 법률에 따라 위탁 계약 시 개인정보가 안전하게 관리될 수 있도록 필요한 사항을 규정하고, 수탁 업체가 개인정보를 위법하게 이용하지 않도록 관리 감독하고 있습니다.</h2>
	</li>
	<li>
	...
	<table border="1" cellpadding="1" cellspacing="1">
		...
		<tbody>
			<tr>
				<td>HCY네트웍스㈜</td>
				<td>시스템 운영 위탁<br>
				HCY옴니서비스 이용약관 및 개인정보 제3자 제공 관련 동의 수령/철회/관리 업무<br>
				개인정보의 가명처리 업무</td>
			</tr>
			<tr>
				<td>디아이웨어(HCY네트웍스㈜ 재위탁 업체)</td>
				<td>극장영업 및 온라인 시스템 운영</td>
			</tr>
			<tr>
				<td>임팩소프트(HCY네트웍스㈜ 재위탁 업체)</td>
				<td>온라인 시스템 운영</td>
			</tr>
			<tr>
				<td>씨에스피아이(HCY네트웍스㈜ 재위탁 업체)</td>
				<td>극장영업 시스템 운영</td>
			</tr>
			<tr>
				<td>미래아이엔텍(CY네트웍스㈜ 재위탁 업체)</td>
				<td>극장영업 시스템 운영</td>
			</tr>
			<tr>
				<td>위즈베이스(HCY네트웍스㈜ 재위탁 업체)</td>
				<td>극장영업 DBA</td>
			</tr>
			<tr>
				<td>㈜메이아이(HCY네트웍스㈜ 재위탁 업체)</td>
			...
			<tr>
				<td>㈜스마트콘</td>
				<td>HCY PLUS 서비스 이용 고객 대상 HVING 이용권 관련 업무 위탁</td>
			</tr>
		</tbody>
	</table>
	</li>
...
<ol class="terms_list_circleNum">
	...
	<ol>
		<li>
		<h3>개인정보보호책임자 : 도형구<br>
		E-MAIL : <a href="mailto:cjcgvmaster@cj.net">hcymaster@hcy.net</a><br>
		...
		<li>
		<h3>개인정보 민원 처리<br>
		에이치씨와이씨네마㈜는 귀하의 의견을 소중하게 생각하며, 귀하와의 원활한 의사소통을 위해 민원처리센터를 운영하고 있습니다.<br>
...
<ol class="terms_list_circleNum">
	<li>
	<h2>에이치씨와이씨네마㈜는 회원의 정보를 수시로 저장하고 찾아내는 ‘쿠키(cookie)’를 사용합니다. 쿠키란 에이치씨와이씨네마㈜의 웹사이트를 운영하는 데 이용되는 서버가 회원의 브라우저에 보내는 아주 작은 텍스트 파일로써 회원의 컴퓨터 하드 디스크에 저장됩니다.</h2>
	</li>
	<li>
	<h2>에이치씨와이씨네마㈜는 다음과 같은 목적을 위해 쿠키를 사용하며, 쿠키는 브라우저의 종료 시나 로그아웃 시 만료됩니다.</h2>
	...
	<ol class="noneSpace">
		...
		<li>
		<h3>에이치씨와이씨네마㈜가 진행하는 각종 이벤트에서 회원의 참여 정도 및 방문 횟수를 파악하여 차별적인 응모 기회를 부여하고 개인의 관심 분야에 따라 차별화된 정보를 제공하기 위한 자료로 이용됩니다.</h3>
		</li>
	</ol>
	</li>
	<li>
...
<ol class="terms_list_circleNum">
	<li>
	<h2>에이치씨와이씨네마㈜는 회원이 에이치씨와이씨네마㈜의 모바일 앱(APP) 이용 시 사용자에게 맞춤 서비스와 더 나은 환경의 광고 제공을 위한 측정을 위해 모바일 앱 이용자의 광고식별 값으로서 광고식별자(ADID/IDFA)를 수집할 수 있습니다.</h2>
	</li>
	<li>
...
<ol class="terms_list_circleNum">
	<li>
	<h2>에이치씨와이씨네마㈜는 Google, Inc. (이하 ‘Google’)에서 제공하는 웹 분석 도구인 Google Analytics를 이용하여 고객들의 서비스 이용 행태 및 수요를 파악하여 보다 효율적인 서비스를 제공하기 위한 목적으로 행태정보를 수집·이용하고 있습니다.</h2>
	</li>
	<li>
	<h2>에이치씨와이씨네마㈜는 Google Analytics를 통해 본조 제1항의 목적을 위해 필요한 최소한의 행태정보만을 수집하며, 사상, 신념, 가족 및 친인척관계, 학력·병력, 기타 사회활동 등 개인의 권리·이익이나 사생활을 뚜렷하게 침해할 우려가 있는 민감한 행태정보와 개인을 식별할 수 있는 정보는 수집하지 않습니다.</h2>
	</li>
	<li>
	<h2>에이치씨와이씨네마㈜는 다음과 같이 행태정보를 수집합니다.</h2>
	...
	<table border="1" cellpadding="1" cellspacing="1" class="tAlignC">
		...
		<tbody>
			<tr>
				...
				<td>HCY 온/모바일 채널 내 방문자(고객) 상호작용에 대한 서비스 분석 및 통계</td>
				<td>회원 탈퇴 시까지</td>
			</tr>
		</tbody>
	</table>
...
<ol class="terms_list_circleNum">
	<li>
	<h2>회원은 언제든지 등록되어 있는 회원의 개인정보를 열람ㆍ정정ㆍ삭제ㆍ처리정지를 요청하실 수 있습니다. 회원의 개인정보에 대한 열람 또는 정정을 하고자 할 경우에는 [개인정보변경](또는 [회원정보수정]등)을 클릭하여 본인 확인 절차를 거치신 후 직접 열람 또는 정정하거나, <a href="mailto:cjcgvmaster@cj.net">hcymaster@hcy.net</a>, 1544-1122로 연락하시면 지체 없이 조치하겠습니다. 개인정보의 이용내역, 처리위탁 및 제3자 제공 내역 등에 대해서는 <a href="mailto:cjcgvmaster@cj.net">hcymaster@hcy.net</a>, 1544-1122로 요청 시 열람 또는 정정 가능합니다. 개인정보의 처리정지를 원하실 경우 회원탈퇴/약관철회를 하시거나 <a href="mailto:cjcgvmaster@cj.net">hcymaster@hcy.net</a>, 1544-1122로 요청하실 수 있습니다.</h2>
	</li>
	<li>
	...
	<li>
	<h2>본조 제1항에도 불구하고 에이치씨와이씨네마㈜는 다음 각 호의 어느 하나에 해당하는 경우에는 회원에게 그 사유를 알리고 열람 또는 처리정지 요구 등을 제한하거나 거절할 수 있습니다.</h2>
...
<ol class="terms_list_circleNum">
	...
	동의철회(회원탈퇴)는 ‘홈페이지 My Page → 회원정보 → 회원탈퇴’ 또는 ‘모바일 앱 → My Page → 개인정보관리 → 회원탈퇴’를 클릭하여 본인 확인 절차를 거치신 후 직접 동의철회(회원탈퇴)를 하시거나, <a href="mailto:cjcgvmaster@cj.net">hcymaster@hcy.net</a>, 1544-1122 등으로 연락하시면 회원의 개인정보를 파기하는 등 필요한 조치를 하겠습니다.</h2>
	</li>
</ol>
...
<ol class="terms_list_circleNum">
	<li>
	<h2>에이치씨와이씨네마㈜는 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체 없이 해당 개인정보를 파기합니다. 다만, 다음 각 호의 경우 일정기간 동안 예외적으로 수집한 회원정보의 전부 또는 일부를 보관할 수 있습니다.</h2>
	...
	<ol class="noneSpace">
		...
		<li>
		<h3>「개인정보 보호법」 등 관련 법률에 따라 1년 동안 HCY 이용 실적이 없는 미이용 고객의 경우 고객정보 별도 분리 보관</h3>
		...
		<ol>
			...
			<li>
			<h4 data-list-text="다">분리 보관 고객이 웹/모바일 로그인을 하거나 HCY 현장에서 포인트를 적립/사용하는 경우, 고객 상담 등의 서비스 이용 시 재이용 신청으로 간주하며 해당 계정은 자동 복원됩니다.</h4>
			</li>
		</ol>
		</li>
		<li>
	...
	<li>
	<h2>에이치씨와이씨네마㈜는 전자적 파일형태로 기록ㆍ저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 이용하여 파기하며, 종이 문서에 기록ㆍ저장된 개인정보는 분쇄기로 분쇄하거나 소각하여 파기합니다.</h2>
	</li>
</ol>
...
<ol class="terms_list_circleNum">
	<li>
	<h2>에이치씨와이씨네마㈜는 만 14세 미만 아동의 정보 수집이 필요한 경우 법정대리인의 동의를 받습니다.<br>
...
<ol class="terms_list_circleNum">
	<li>
	<h2>가명정보 처리 목적<br>
	에이치씨와이씨네마㈜는 개인정보보호법 제28조의2 제1항에 따라 통계작성, 과학적 연구, 공익적 기록보존 등을 위하여 정보주체의 동의 없이 가명정보를 처리할 수 있습니다.</h2>
	</li>
	<li>
	<h2>가명정보 처리 및 보유 기간<br>
	에이치씨와이씨네마㈜는 가명정보를 이용할 때 처리 및 보유기간을 정하고 있으며, 해당 기간이 경과할 시 더 이상 이용하지 않고 해당 정보를 지체없이 파기합니다.</h2>
	</li>
	<li>
	...
	<ol>
		<li>
		<h3>에이치씨와이씨네마㈜는 가명정보를 처리하는 경우에는 원래의 상태로 복원하기 위한 추가 정보를 별도로 분리하여 보관ㆍ관리하는 등 해당 정보가 분실ㆍ도난ㆍ유출ㆍ위조ㆍ변조 또는 훼손되지 않도록 개인정보보호법 시행령 제29조의5에서 정하는 바에 따라 안전성 확보에 필요한 기술적ㆍ관리적 및 물리적 조치를 취합니다.</h3>
		...
		<li>
		<h3>에이치씨와이씨네마㈜는 가명정보를 처리하고자 하는 경우에는 가명정보의 처리 목적, 제3자 제공 시 제공받는 자 등 가명정보의 처리 내용을 관리하기 위하여 개인정보보호법 시행령 제29조의5에서 정하는 사항에 대한 관련 기록을 작성하여 보관합니다.</h3>
		</li>
	</ol>
	</li>
	<li>
	<h2>현재 에이치씨와이씨네마㈜가 처리하는 가명정보 항목, 처리 목적, 보유 및 이용기간, 제3자 제공 및 처리 위탁 현황에 관한 사항은 아래에서 확인하실 수 있습니다.</h2>
...
<p>에이치씨와이씨네마㈜는 위치정보의 보호 및 이용 등에 관한 법률(이하 ‘위치정보법’)에 따라 이용자의 개인위치정보를 안전하게 관리합니다.</p>
...
<ol class="terms_list_circleNum">
	...
	에이치씨와이씨네마㈜는 ‘위치정보법’ 제16조 제2항에 따라 개인위치정보 이용‧제공사실 확인자료를 자동으로 기록·보존하며, 해당 자료는 6개월 간 보관합니다.</h2>
	</li>
	<li>
	...
	에이치씨와이씨네마㈜는 개인위치정보주체의 사전 동의 없이 위치정보를 제3자에게 제공하지 않습니다. 단, 개인위치정보주체가 직접 동의를 한 경우, 그리고 관련 법령에 의거해 씨제이씨지브이㈜에 제출 의무가 발생한 경우, 이용자의 생명이나 안전에 급박한 위험이 확인되어 긴급구조기관 및 경찰관서의 제공 요청이 있는 경우에 한하여 개인위치정보를 제공합니다.</h2>
	</li>
	<li>
	<h2>개인위치정보의 이용 또는 제공에 따른 통보에 관한 사항<br>
	에이치씨와이씨네마㈜는 개인위치정보를 이용자가 지정하는 제3자에게 제공하는 경우 개인위치정보를 수집한 통신단말장치로 매회 이용자에게 제공받는 자, 제공일시 및 제공목적을 즉시 통보합니다. 단, 아래의 경우 이용자가 미리 특정하여 지정한 통신단말장치 또는 전자우편주소, 온라인게시 등으로 통보합니다.</h2>
	...
	<li>
	<h2>에이치씨와이씨네마㈜는 개인위치정보를 적절히 관리‧보호하고, 이용자의 불만, 요청 등을 원활하게 처리할 수 있도록 위치정보 관리책임자를 지정하여 운영하고 있으며, 개인정보보호책임자가 겸직하고 있습니다.</h2>
...
<p>에이치씨와이씨네마㈜는 영상정보처리기기 운영 및 관리 방침을 통해 에이치씨와이씨네마㈜에서 영상 정보가 어떠한 용도와 방식으로 이용·관리 되고 있는지 알려드립니다.</p>

<ol class="terms_list_circleNum">
	<li>
	<h2>영상정보처리기기의 설치 근거 및 설치 목적<br>
	에이치씨와이씨네마㈜는 개인정보보호법 제25조 제1항에 따라 시설 안전 및 화재 예방, 고객의 안전을 위한 범죄 예방, 통계 작성을 위한 가명정보 처리 및 데이터 분석을 목적으로 영상정보처리기기를 설치·운영하고 있습니다.</h2>
	</li>
	<li>
	...
	각 극장의 개인영상정보 보호책임자 또는 에이치씨와이씨네마㈜ 고객센터에 연락하시고 방문하시면 됩니다.</h2>
	</li>
	<li>
	<h2>정보주체의 영상정보 열람 등 요구에 대한 조치<br>
	개인영상정보에 관하여 열람 또는 존재 확인, 삭제를 원하는 경우 언제든지 에이치씨와이씨네마㈜에 요구하실 수 있습니다. 단, 정보주체 자신이 촬영된 개인영상정보 및 명백히 정보주체의 급박한 생명, 신체, 재산의 이익을 위하여 필요한 개인영상정보에 한정됩니다.<br>
	에이치씨와이씨네마㈜는 개인영상정보에 관하여 열람 또는 존재 확인, 삭제를 요구한 경우 해당 요구를 검토하여 지체 없이 필요한 조치를 취할 것이며 불가피하게 해당 요구를 거부하는 경우에는 그 사유를 통지하도록 하겠습니다.</h2>
	</li>
	<li>
	<h2>영상정보의 안전성 확보 조치<br>
	에이치씨와이씨네마㈜는 폐쇄 네트워크 또는 방화벽 등의 보안 시스템을 통하여 고객의 영상정보를 보호하고 있습니다. 또한 개인영상정보 보호를 위하여 해당 영상정보를 처리하는 인원을 최소한으로 제한하고 있으며 지속적인 교육을 시행하고 있습니다. 개인영상정보의 임의적인 처리를 제한하기 위하여 개인영상정보의 열람 시 열람 목적, 열람자, 열람 일시 등을 기록, 관리하고 있으며 영상정보의 보관 장소는 보안구역으로 정하고 사전 승인된 인력 외에는 출입을 통제하고 있습니다.</h2>
	</li>
	<li>
	<h2>영상정보처리기기 운영 및 관리방침 변경에 관한 사항<br>
	관계 법률, 정책 또는 보안 기술의 변경에 따라 내용의 추가, 삭제 및 수정이 있을 시에는 시행하기 최소 7일 전에 에이치씨와이씨네마㈜ 홈페이지를 통해 변경 사유 및 내용 등을 공지하도록 하겠습니다.</h2>
	</li>
</ol>
