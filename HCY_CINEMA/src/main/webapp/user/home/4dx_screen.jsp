...
<!-- S Contaniner -->
    <div id="contaniner">
        ...
        <!-- 상단 띠베너-->
        <article class="special_detail_top">  <div class="contents">      <div class="img_wrap" data-scale="false">          <img src="http://img.cgv.co.kr/WebApp/contents/specialTheater/list1/16844581159620.png" alt="최대치의 공감각" onerror="errorImage(this)">      </div>      <strong class="special_detail_title">4DX SCREEN</strong>      <span class="special_detail_subTitle">최대치의 공감각<span>  </span></span></div></article>
        <!-- BI 리스트-->
        <!-- 유닛관리-->
