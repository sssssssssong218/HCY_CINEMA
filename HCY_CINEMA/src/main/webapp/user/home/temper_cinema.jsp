...
<div id="contaniner">
        ...
        <!-- 상단 띠베너-->
        <article class="special_detail_top">  <div class="contents">      <div class="img_wrap" data-scale="false">          <img src="http://img.cgv.co.kr/WebApp/contents/specialTheater/list1/16844575096390.png" alt="리클라이닝 침대 상영관" onerror="errorImage(this)">      </div>      <strong class="special_detail_title">TEMPUR CINEMA</strong>      <span class="special_detail_subTitle">리클라이닝 침대 상영관<span>  </span></span></div></article>
        <!-- BI 리스트-->
        <!-- 유닛관리-->
        <article class="specialtheater_detail_edit_wrap"><div class="contents"><strong class="specialtheater_detail_edit_title tAlignC">World's 1st Reclining Bed Cinema</strong> <span class="specialtheater_detail_edit_context tAlignC"> NASA(미 항공 우주국)의 신소재로 유명한 프리미엄 매트리스&amp;베개 브랜드<br>
‘템퍼’와의 콜라보레이션으로 탄생한 세계 최초 리클라이닝 침대 영화관 입니다. </span> <img alt="THE PRIVATE CINEMA 이미지1" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/tempurcinema/tempurcinema_0.jpg"> <strong class="specialtheater_detail_edit_title">Prestige, Comfort, Private</strong> <span class="specialtheater_detail_edit_context">비교할 수 없는 특별함, 잊을 수 없는 편안함, 소중한 우리만의 시간<br>
전 좌석 최고급 리클라이닝 템퍼 모션 베드, 웰컴 패키지 (프리미엄 드링크+다크 초콜릿) 제공 </span>
<div class="specialtheater_detail_theaterInfo_wrap">
<div class="specialtheater_detail_theaterInfo_img_wrap"><img alt="Prestige, Comfort, Private 사진1" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/tempurcinema/tempurcinema_10.jpg"> <img alt="Prestige, Comfort, Private 사진2" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/tempurcinema/tempurcinema_11.jpg"></div>
</div>
<strong class="specialtheater_detail_edit_title">Zero Gravity Cinema</strong> <span class="specialtheater_detail_edit_context">최상의 영화관람을 위해 주문제작된 템퍼 오리지날 매트리스와 제로지 라이프 (Zero-G Lifestyle)에서 편안함을 경험하세요</span><img alt="Zero Gravity Cinema" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/tempurcinema/tempurcinema_2.jpg"></div></article>
        
        <article class="specialtheater_detail_event_wrap">    <div class="contents">        <h4 class="specialtheater_detail_title">TEMPUR CINEMA 이벤트</h4>            <div class="specialtheater_detail_event_list_wrap">            <div class="swiper specialtheater_detail_event_list noneSlider">                <div class="swiper-wrapper">                <div class="swiper-slide">                    <a href="/culture-event/event/detailViewUnited.aspx?seq=38718&amp;menu=">                        <div class="img_wrap"><img src="http://img.cgv.co.kr/WebApp/contents/eventV4/38718/16980379501550.jpg" onerror="errorImage(this)"></div>                        <strong>옥토버페스트 vol.2
with FREE! 기네스</strong>                        <span>2023.10.25 ~ 2023.11.07</span>                    </a>                </div>                </div>                <div class="event-button-next event-button-next"></div>                <div class="event-button-prev"></div>        </div>    </div></div></article>
        <article class="specialtheater_detail_link_info_wrap">    <div class="contents">        <div class="specialtheater_detail_link_info_txt_wrap">            <strong>고객</strong>님, 이런 정보 찾고 계신가요?         </div>        <ul class="specialtheater_detail_link_info_list">            <li><a href="http://www.cgv.co.kr/theaters/theaterPrice.aspx?tc=0013&amp;spe=TEM">가격안내</a></li>        <!-- ul -->    <!-- div --></ul></div></article>
