...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ko" lang="ko"><head>
    ...
    <meta name="description" content="HCY는 선진화된 관람문화와 최고의 서비스로 고객에게 잊을 수 없는 감동을 선사합니다. CGV홈페이지를 통해 영화 예매뿐만 아니라 그 이상의 서비스와 감동을 전달하고, 다양한 즐거움과 특별한 경험을 제공하고자 합니다.">
...
<div id="contaniner">
        ...
        <!-- 상단 띠베너-->
        <article class="special_detail_top">  <div class="contents">      <div class="img_wrap" data-scale="false">          <img src="http://img.cgv.co.kr/WebApp/contents/specialTheater/list1/16844567162940.png" alt="초대형 스크린" onerror="errorImage(this)">      </div>      <strong class="special_detail_title">STARIUM</strong>      <span class="special_detail_subTitle">초대형 스크린<span>  </span></span></div></article>
        <!-- BI 리스트-->
        <!-- 유닛관리-->
        <article class="specialtheater_detail_edit_wrap"><div class="contents"><strong class="specialtheater_detail_edit_title tAlignC">Beyond Reality</strong> <span class="specialtheater_detail_edit_context tAlignC"> 모든 감각을 압도하는 스케일의 스크린, 놀랍도록 생생한 화질, 가슴 뛰게 하는 16채널 사운드까지 ‘현실’ 그 이상의 경험을 스타리움에서 만나보세요 </span></div>

<div class="specialtheater_detail_edit_contents_wrap">
<div class="contents">
<ul class="starium_list">
	<li>
	<div class="img_wrap" data-scale="false"><img alt="최대 시야각 스크린" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/starium/starium_list0.png"></div>
	<strong>최대 시야각 스크린</strong></li>
	<li>
	<div class="img_wrap" data-scale="false"><img alt="4K 초고해상도 영상" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/starium/starium_list1.png"></div>
	<strong>4K 초고해상도 영상</strong></li>
	<li>
	<div class="img_wrap" data-scale="false"><img alt="Lay Back Seat" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/starium/starium_list2.png"></div>
	<strong>16채널 입체 사운드</strong></li>
</ul>
</div>
</div>

<div class="contents"><strong class="specialtheater_detail_edit_title">Super Giant Screen</strong> <span class="specialtheater_detail_edit_context">최대 시야각을 보장하는 초대형 스크린</span><img alt="Super Giant Screen - 최대 시야각을 보장하는 초대형 스크린의 현장감 넘치는 영상" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/starium/specialtheater_starium0.jpg"> <strong class="specialtheater_detail_edit_title">Most Dynamic Sound</strong> <span class="specialtheater_detail_edit_context">좌석위치에 관계없이 동일하게 전달되는 16채널 사운드시스템</span> <img alt="Most Dynamic Sound - 좌석위치에 관계없이 동일하게 전달되는 16채널 사운드시스템" src="https://img.cgv.co.kr/resource_pc/images/specialtheater/starium/specialtheater_starium1.jpg"></div></article>
        
        
        <article class="specialtheater_detail_link_info_wrap">    <div class="contents">        <div class="specialtheater_detail_link_info_txt_wrap">            <strong>고객</strong>님, 이런 정보 찾고 계신가요?         </div>        <ul class="specialtheater_detail_link_info_list">            <li><a href="http://www.cgv.co.kr/theaters/theaterPrice.aspx?tc=0089&amp;spe=110">가격안내</a></li>        <!-- ul -->    <!-- div --></ul></div></article>
