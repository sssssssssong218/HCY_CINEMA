...
<div class="col-detail" style="margin-left: 185px;">
			...
			<form name="frmWrite" id="frmWrite" action="http://localhost/HCY_CINEMA/user/board/board_write_prcs.jsp" method="post">
					<li class="title">
					<span style="color: #333333; font-family: Noto-Sans KR; font-size: 12px; margin-left: 20px"><em>제목</em></span>
					<input type="text" id="titleTxt" name="titleTxt" class="inputBox" style="width: 350px; height: 24px; margin-left: 10px;"/>
					</li>
				</ul>
				<div class="view_area">
