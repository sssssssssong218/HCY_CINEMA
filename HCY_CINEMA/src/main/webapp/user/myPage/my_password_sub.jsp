...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ko" lang="ko"><head>
    ...
    <title id="ctl00_headerTitle">비밀번호 변경 &lt; 로그인 | 영화 그 이상의 감동. HCY</title>
...
<div class="wrap-login">
        ...
        <!-- ******************************************** 수정된 부분 시작! ******************************************** -->
	                 ...
	                 <form action="http://localhost/HCY_CINEMA/user/myPage/my_password_sub_process.jsp" id="hidFrm" name="hidFrm" method="post">
                                       <input type="hidden" id="pw" name="pass"/>
	                 </form>
   <!-- ******************************************** 수정된 부분 끝! ******************************************** -->
    </div>    
...
<!-- find id -->
<form name="frmFindAccount" id="frmFindAccount" method="post" action="http://localhost/HCY_CINEMA/user/ticketing/ticketing_main_frame_err_msg.jsp" novalidate="novalidate">   
