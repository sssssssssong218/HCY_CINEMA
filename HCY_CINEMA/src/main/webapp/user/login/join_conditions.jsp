...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ko" lang="ko"><head>
  ...
  $(function(){
		$("#btnOk").click(function(){
			$("#name").val("<%= new String(request.getParameter("name").getBytes("8859_1"),"UTF-8")%>")
...
<div class="wrap-login">
    ...
    <p>에이치씨와이씨네마(주) 는 회원님의 개인정보를 매우 중요시하며, <strong>정보통신망 이용촉진 및 정보보호 등에 관한 법률,</strong><br>개인정보 보호법 등 관련 법률을 준수하고 있습니다.<br>씨제이씨지브이(주) 는 개인정보 처리방침을 통하여 회원님께서 제공한 개인정보가 어떠한 용도와 방식으로 이용되고 있으며,<br> 개인정보보호를 위해어떠한 조치가 취해지고 있는지 알려드립니다.</p>
...
<ol class="terms_list_circleNum">
	...
	<ol>
		<li>
		<h3>개인정보 수집 방법</h3>
		<span>에이치씨와이씨네마㈜는 HCY 홈페이지와 HCY 홈페이지 및 모바일, 현장, 로그분석, 쿠키를 통해 회원정보를 수집하고 있습니다.</span></li>
		<li>
		<h3>개인정보 수집에 대한 동의 절차</h3>
		<span>회원의 개인정보 수집과 관련하여 에이치씨와이씨네마㈜ 및 HCY의 개인정보처리방침 또는 이용약관을 통해 그 내용을 고지하고 있으며, 회원에게 수집하는 개인정보의 항목과 이용목적 및 보유기간, 거부권에 대해 고지 후 회원이 내용에 대해 「동의」 버튼을 클릭하면 개인정보 수집에 대해 동의한 것으로 봅니다. HCY는 서비스 제공에 반드시 필요한 필수 항목과 부가적인 서비스 제공을 위한 선택 항목을 구분하여 고객 동의를 받고 있으며, 선택 항목은 서비스 내용 및 목적에 따라 별도 동의를 받고 있습니다.</span></li>
	</ol>
	</li>
</ol>
...
<ol class="terms_list_circleNum">
	...
	<table border="1" cellpadding="1" cellspacing="1">
		...
		<tbody>
			...
			<tr>
				<td>㈜스마트콘</td>
				<td>HCY PLUS 서비스 이용 고객 대상 에이치빙 이용권 관련 업무 위탁</td>
			</tr>
		</tbody>
	</table>
	</li>
...
<ol class="terms_list_circleNum">
	<li>
	<h2>회원의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 에이치씨와이씨네마㈜는 개인정보보호책임자를 두고 있습니다. 개인정보와 관련한 문의 사항이 있으시면 아래의 개인정보보호책임자에게 연락 주시기 바랍니다. 회원의 문의 사항에 신속하고 성실하게 답변해 드리겠습니다.</h2>
...
<ol class="terms_list_circleNum">
	<li>
	<h2>에이치씨와이씨네마㈜는 고객의 개인정보가 분실, 도난, 변조, 유출 또는 훼손되지 않도록 다음 각 호와 같은 기술적, 관리적 보호 조치를 시행하고 있습니다.</h2>
...
<ol class="terms_list_circleNum">
	...
	에이치씨와이씨네마㈜는 개인위치정보주체의 사전 동의 없이 위치정보를 제3자에게 제공하지 않습니다. 단, 개인위치정보주체가 직접 동의를 한 경우, 그리고 관련 법령에 의거해 에이치씨와이씨네마㈜에 제출 의무가 발생한 경우, 이용자의 생명이나 안전에 급박한 위험이 확인되어 긴급구조기관 및 경찰관서의 제공 요청이 있는 경우에 한하여 개인위치정보를 제공합니다.</h2>
	</li>
	<li>
...
<p>본 개인정보처리방침은 2004년 6월 25일에 제정되었으며 법률∙정책 또는 보안기술의 변경에 따라 내용의 추가∙삭제 및 수정이 있을 시에는 변경되는 개인정보처리방침을 시행하기 최소 7일 전에 씨제이씨지브이㈜ 인터넷 사이트를 통해 변경 이유 및 내용 등을 공지하도록 하겠습니다.</p>
                    ...
                    <form>
	                    <input type="button" id="btnOk" name="btnOk" class="btn btn-danger" value="동의" style="width: 200px">
	                    <input type="button" id="btnCancle" name="btnCancle" class="btn btn-secondary" value="취소" style="width: 200px">
                    </form>
                   </div>
