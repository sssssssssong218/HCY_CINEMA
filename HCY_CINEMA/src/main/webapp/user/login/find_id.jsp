...
<div class="wrap-login">
            <div class="sect-user">
                ...
                <h3>아이디 찾기</h3>
                <p>
                    아이디가 기억나지 않으세요? 기본 정보를 입력하여 아이디를 확인하실 수 있습니다. <br>
                    아이디 찾기를 위해 제공되는 정보는 해당 인증기관에서 직접 수집 하며, 인증 이외의 용도로 이용 또는 저장하지 않습니다.    
                </p>
                        ...
                        <div class="cols-enterform find_0826 find_pw_id">
                            <div class="col-confirm">
                                ...
                                <div class="box-confirm">
                                   <h5>입력하신 정보는 아이디 찾기에만 사용되며 <span style="color:orange;">저장되지 않습니다.</span></h5>
