...
<span>Bootstrap 4</span>
						...
						<li class="active has-sub"><a href="http://localhost/HCY_CINEMA/admin/manageBoard/notice_list.jsp"> <img class="fa fa-file" src="http://localhost/HCY_CINEMA/common/images/notice_icon.png">
                                <span>공지사항 관리</span>
                         </a></li>
				</ul></div>
...
<!-- 게시판 검색 시작 { -->
    <fieldset id="bo_sch">
        ...
        <select name="field" id="field">
            ...
            <option value="1"${param.field eq '1'?" selected='selected'":"" }>구분</option>
...
<div align="right">
<button type="button" class="btn btn-dark" style="width:150px;height:50px"><a href="http://localhost/HCY_CINEMA/admin/manageBoard/notice_write.jsp"><font style="color:white">글 쓰기</font></a></button>
</div><br>
<!-- } 게시판 페이지 정보 및 버튼 끝 -->
    ...
    <div class="tbl_head01 tbl_wrap">
       ...
       if (noticeNumParam != null && !noticeNumParam.isEmpty()) {
    	   noticeNum = Integer.parseInt(noticeNumParam);
       }//end if
       ...
       //총 레코드 수
       int totalCount= mnDAO.totalCount(brVO);
	...
	<strong>
	<font size="4">
       총<%= totalCount %>개의 공지사항이 조회되었습니다.</font><br/><br/>
    </strong>   
       <%
       try{
       List<NoticeVO> list=ManageNoticeDAO.getInstance().selectNotice(brVO);
       ...
       <tr style="background-color: #FF2121; text-align: center;">
            <th scope="col" style="width: 200px"><strong>공지사항 번호</strong></th>
            <th scope="col" style="width: 200px"><strong>구분</strong></th>
        ...
        <tr>
        	<td colspan="5" style="text-align:center"><strong><font size="5">공지사항이 않습니다</font></strong></td>
        </tr>
        </c:if>
        ...
        <tr class="bo_notice" bgcolor="#ffffff" onmouseover="this.style.backgroundColor='#fafafa'" onmouseout="this.style.backgroundColor='#ffffff'" style="background-color: rgb(255, 255, 255);">
        	...
        	<td><c:out value="${ notice.section }"/></a></td>
       		<td><a href="http://localhost/HCY_CINEMA/admin/manageBoard/notice_info.jsp?noticeNum=<c:out value='${ notice.noticeNum }'/>"><c:out value="${notice.title }"/></a></td>
        ...
        <nav aria-label="Page navigation example" style="text-align:center">
                        ...
                        <ul class="pagination">
	                     ...
	                     <% for( int i=1; i<totalPage+1; i++ ){   %>
	                      <a href="http://localhost/HCY_CINEMA/admin/manageBoard/notice_list.jsp?currentPage=<%=i %>&keyword=${ param.keyword }&field=${param.field}"><%=i%></a> 
	                     <%} //end for%> 
	                   </li>
	                  </ul>
