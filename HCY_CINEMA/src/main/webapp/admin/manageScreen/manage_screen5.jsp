...
<span>Bootstrap 4</span>
  ...
  <li class="nav-item">
    <a class="nav-link active" href="http://localhost/HCY_CINEMA/admin/manageScreen/manage_screen5.jsp">5관</a>
  </li>
</ul>
<style>
.modal {
...
<input type="hidden" name="screenNum" value="5" id="screenNum">
