...
<body>
<%
File saveDir = new File("C:/Users/user/git/HCY_CINEMA/HCY_CINEMA/src/main/webapp/common/still_img_upload");
...
try {
    ...
    String newfile = mr.getFilesystemName("still_file");
    ...
    String originfile = mr.getOriginalFileName("still_file");
