...
<body>
	...
	%>
	<strong>스틸컷의 확장자는 jpg또는 png만 가능합니다</strong>
	<br />
	<a
		href="http://localhost/HCY_CINEMA/admin/manageMovie/manage_detail_movie.jsp?movieCode=<%=movieCode%>">뒤로가기</a>
	...
	nfe.printStackTrace();
	%>
	상영시간은 숫자로만 입력이 가능합니다.
	<br /> 뒤로가시려면
	<a
		href="http://localhost/HCY_CINEMA/admin/manageMovie/manage_detail_movie.jsp">여기</a>를
	클릭해주세요
